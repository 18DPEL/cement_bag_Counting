...
DEFAULT_MODEL_PATH  = resource_path(r"C:\Users\ayuba\Downloads\Cement_truck.pt")
# =========================
...
MQTT_TOPIC_CURRENT_COUNT = 'cement/wagon/cantrol/current_count'  # NEW: Topic for current count
MQTT_TOPIC_TARGET_REACHED = 'cement/wagon/control/target_reached'  # NEW: Topic for target reached
...
class VideoThread(QThread):
    ...
    def __init__(self, parent=None):
        ...
        # NEW: Timer for periodic count publishing
...
class MainWindow(QMainWindow):
    ...
    def handle_target_reached(self, current_count, target_count):
        ...
        # NEW: Send MQTT notification to target reached topic
    ...
    # NEW: Send current count to MQTT every 3 seconds
